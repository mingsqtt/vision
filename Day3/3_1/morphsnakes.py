...
def visual2d(background, fig=None):
    """
    ...
    def callback(levelset):
        ...
        if not ax.collections:
            ax.contour(levelset, [0.5], colors='lawngreen')
        elif len(ax.collections) == 1:
            ax.contour(levelset, [0.5], colors='orangered')
        else:
            del ax.collections[len(ax.collections)-1]
            ax.contour(levelset, [0.5], colors='orangered')
